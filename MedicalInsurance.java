package org.ml;
	...
	public class MedicalInsurance {
		...
		public static void main(String args[]) {
			...
			HistogramTrace t2=HistogramTrace.builder(insurance_data.categoricalColumn("smoker=no"), insurance_data.nCol("charges")).build();
			...
			Instances train_data = getInstances("C:\\Users\\Srilasya Punna\\OneDrive\\Desktop\\train_dataset.arff");
			Instances test_data = getInstances("C:\\Users\\Srilasya Punna\\OneDrive\\Desktop\\test_dataset.arff");
